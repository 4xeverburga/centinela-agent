...
_SCHEMA_EXAMPLE = """{{
  ...
  "observation": "<comentarios del técnico relacionados, vacío si no hay>",
...
USER_PROMPT_TEMPLATE = (
    ...
    "1. Clasifica el equipo y determina el estado de la intervención ÚNICAMENTE "
    "a partir de lo que se observa en la imagen:\n"
    "   - DURANTE: la imagen muestra trabajo en progreso (cableado expuesto, "
    "equipo siendo montado, soporte sin cerrar, herramientas visibles, técnico en escena, "
    "componentes sin ensamblar, tapas abiertas).\n"
    "   - DESPUES: la imagen muestra trabajo terminado (equipo en posición final, "
    "tapas y cubiertas cerradas, cableado oculto o canalizado, sin herramientas ni residuos de obra).\n"
    "   El estado se determina por la evidencia visual de la imagen, NO por el contexto "
    "de mensajes o inspecciones anteriores. Si el equipo se ve cerrado y terminado, "
    "es DESPUES aunque imágenes previas del mismo equipo fueran DURANTE.\n"
